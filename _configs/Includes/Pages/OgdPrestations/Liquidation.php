    ...
    if(empty($user['ID_UTILISATEUR'])) {
        ...
        if ($nb_modules == 0) {
            ...
            if(in_array('OGDP', $modules)) {
                ...
                if(in_array('LIQ', $user_hab)) {
                    ?>
                    <div class="col">
                        <input type="hidden" id="user_input" value="<?= $user['ID_UTILISATEUR']; ?>"/>
                        <p class="titres_p"><b class="fa fa-file-upload"></b> Liquidation</p>
                        <hr>
                        <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-sm"
                                                       id="numero_facture_input" placeholder="numéro de la facture"
                                                       autocomplete="off" style="text-align: right"/>
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="hidden" id="type_verification_input" value="LIQ"/>
                                                <button type="submit" id="btn_recherche"
