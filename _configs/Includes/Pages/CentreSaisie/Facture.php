    ...
    if(empty($user['ID_UTILISATEUR'])) {
        ...
        if($nb_modules == 0) {
            ...
            <div class="container">
                ...
                <p align="right">
                    <a href="<?= URL.'centre-saisie/';?>" class="btn btn-primary btn-sm"><i class="fa fa-chevron-left"></i> Retourner</a>
                    <?php
                    if(empty($facture['STATUT']) || $facture['STATUT'] == '' || $facture['STATUT'] == 'C' || $facture['STATUT'] == 'N' || $facture['STATUT'] == 'F' || $facture['STATUT'] == 'R') {
                        if(empty($facture['TYPE_FEUILLE'])){
                            $lien = URL.'centre-saisie/facture-selection-type.php?num='.$facture['FEUILLE'];
                        }else{
                            $lien = URL.'centre-saisie/facture-edition.php?type='.$facture['TYPE_FEUILLE'].'&num='.$facture['FEUILLE'];
                        }
                        echo '<a href="'.$lien.'" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Editer la facture</a>';
                    }
                    ?>
                </p>

                <p align="center">Statut: <b><?= $facture['STATUT'];?></b></p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                            <?php
                            $actes = $FACTURES->trouver_facture_liste_actes($facture['FEUILLE']);/*var_dump($actes);*/
                            $total_montant = 0;
                            $total_part_assure = 0;
                            $total_part_cmu = 0;
                            $total_part_ac = 0;
                            foreach ($actes as $acte) {
                               ...
                               /*  if($facture['CODE_CSP'] == 'IND') {
								...
								if($facture['CODE_OGD_AFFILIATION'] == '03016000') {$part_ac = $montant - $part_cmu;}else {$part_ac = 0;}
