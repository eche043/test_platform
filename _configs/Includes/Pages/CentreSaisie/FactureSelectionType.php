                    ...
                    if(isset($_POST['num']) && !empty($_POST['num'])) {
                        ...
                        if(!empty($facture['FEUILLE'])) {
                            if(empty($facture['TYPE_FEUILLE'])) {
                                ...
                                echo '<script>window.location.href="'.URL.'centre-saisie/facture-edition.php?type='.$facture['TYPE_FEUILLE'].'&num='.$facture['FEUILLE'].'"</script>';
                            }
                        }else{
