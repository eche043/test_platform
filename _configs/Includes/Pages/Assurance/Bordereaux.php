        ...
        if($nb_modules == 0) {
            ...
            <div class="col">
                ...
                if(in_array('AGAC',$modules))
                {
                    ...
                    ?>
                    <p class="titres_p"><i class="fa fa-newspaper"></i> Bordereaux</p>
                        ...
                        <table class="table table-bordered table-sm table-hover" id="dataTable">
                            ...
                            foreach ($bordereaux as $bordereau) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?= URL.'agent/bordereau.php?num='.$bordereau['NUM_BORDEREAU'];?>" class="badge badge-info" target="_blank"><i class="fa fa-eye"></i></a></td>
                                </tr>
                                <?php
                                $ligne++;
                            }
