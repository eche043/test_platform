                                    ...
                                    if(!empty($assure['NUM_SECU'])) {
                                        ...
                                        if(!empty($type['CODE'])) {
                                            ...
                                            <div class="container" id="div_facture">
                                                ...
                                                <p align="right">
                                                    <a href="<?= URL.'assurance/';?>" class="btn btn-primary btn-sm"><i class="fa fa-chevron-left"></i> Retourner</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <table class="table table-sm table-bordered">
                                                            ...
                                                            <tr style="background-color: #ccc" align="center">
                                                                <td><b>N° Assuré AC</b></td>
                                                                <td><b>Num AC</b></td>
                                                                <td><b>Nom AC</b></td>
                                                            </tr>
                                                            <tr align="center">
                                                                <td></td>
                                                                <td><b style="color: #007bff">SNEDAICMU</td>
                                                                <td>SNEDAICMU</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table class="table table-sm table-bordered">
                                                            ...
                                                            $actes = $CICMU->liste_actes_adjujes($facture['FEUILLE']);
                                                            $total_montant = 0;
                                                            $total_part_assure = 0;
                                                            $total_part_cmu = 0;
                                                            $total_part_ac = 0;
                                                            foreach ($actes as $acte) {
                                                                $details_acte = $FACTURES->trouver_facture_acte($facture['FEUILLE'],$acte['CODE_ACTE']);
                                                                $acte_code = $details_acte['CODE'];
                                                                $designation = strtoupper($details_acte['LIBELLE']);
                                                                $montant = $acte['MONTANT'] * $acte['QUANTITE_SERVIE'];
                                                                $part_cmu = $acte['MONTANT_ADJUJE'];
                                                                $part_ac = $acte['MONTANT_COMPLEMENTAIRE'];
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    if($facture['TYPE_FEUILLE'] != 'EXP' && $facture['TYPE_FEUILLE'] != 'MED') {
                                                                        ...
                                                                        echo '<td>'.date('d/m/Y',strtotime($acte['DATE_DEBUT'])).' - '.date('d/m/Y',strtotime($acte['DATE_FIN'])).'</td>';
                                                                    }
                                                                    ...
                                                                    if($facture['TYPE_FEUILLE'] != 'DEN') {
                                                                        ...
                                                                        echo '<td align="right">'.$acte['QUANTITE_SERVIE'].'</td>';
                                                                    }else{
