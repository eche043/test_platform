                                    ...
                                    if(!empty($assure['NUM_SECU'])) {
                                        ...
                                        if(!empty($type['CODE'])) {
                                            ...
                                            <div class="container" id="div_facture">
                                                ...
                                                <p align="right">
                                                    <a href="<?= URL.'centre-coordination/';?>" class="btn btn-primary btn-sm"><i class="fa fa-chevron-left"></i> Retourner</a>
                                                    <?php
                                                    if($type['CODE'] != 'MED') {
                                                    ...
                                                    <div class="col-sm-12">
                                                        <table class="table table-sm table-bordered">
                                                            ...
                                                            foreach ($actes as $acte) {
                                                                ...
                                                                /* if($facture['CODE_CSP'] == 'IND') {$part_ac = $montant - $part_cmu;}else {$part_ac = 0;} */
