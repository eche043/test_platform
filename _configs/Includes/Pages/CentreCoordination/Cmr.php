            ...
            if(in_array('COORD',$modules)) {
                ...
                if($centre){
                    ...
                    else
                    {
                        ...
                        ?>
                        <div class="col">
                            <p class="titres_p"><i class="fa fa-newspaper"></i> CENTRE MÉDICAL RÉFERENT </p>
                            <?php
                            if($nb_ets) {
                                ?>
                                <table class="table table-bordered table-hover table-sm table-responsive-sm dataTable">
                                    ...
                                    foreach ($etablissements as $etablissement) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="cmr.php?code-ets=<?= $etablissement['CODE_ETS'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $ligne++;
