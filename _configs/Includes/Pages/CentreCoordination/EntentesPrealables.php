                ...
                if($centre){
                    if(isset($_POST['code_ets']) && !empty($_POST['code_ets']))
                    {
                        ...
                        if($ets)
                        {
                          ?>
                            <div class="col">
                                <p class="titres_p">Ententes prealables <?= $ets['RAISON_SOCIALE'] ?></p>
                        ...
                        ?>
                        <div class="col">
                            <p class="titres_p"><i class="fa fa-newspaper"></i> Ententes Préalable par Etablissements</p>
                            <?php
                            if($nb_ets) {
                                ?>
                                <table class="table table-bordered table-hover table-sm table-responsive-sm dataTable">
                                    ...
                                    foreach ($etablissements as $etablissement) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="ententes-prealables.php?code-ets=<?= $etablissement['CODE_ETS'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $ligne++;
