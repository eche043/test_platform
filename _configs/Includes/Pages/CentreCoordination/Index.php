        ...
        if($nb_modules == 0) {
            ...
            if(in_array('COORD',$modules)) {
                ...
                if($centre){
                    ...
                    ?>
                    <div class="col">
                        <p class="titres_p"><i class="fa fa-newspaper"></i> Etablissements</p>
                        <?php
                        if($nb_ets) {
                            ?>
                            <table class="table table-bordered table-hover table-sm table-responsive-sm dataTable" id="">
                            ...
                            foreach ($etablissements as $etablissement) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="etablissement.php?code=<?= $etablissement['CODE_ETS'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php
                                $ligne++;
