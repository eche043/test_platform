                        ...
                        if($bordereau){
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                foreach ($factures as $facture) {
                                    ...
                                    //$part_assure = (round($facture['MONTANT']) - round(($part_cmu + $part_ac)));
                                    ?>
                                    <tr>
                                        ...
                                        <!--<td align="right"><?/* = number_format($facture['MONTANT'] - round($facture['PART_CMU']),'0','',' '); */?></td>
                                        <td align="right"><?/* = number_format(round($facture['PART_CMU']),'0','',' '); */?></td>-->
